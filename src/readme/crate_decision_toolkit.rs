//! # `README.md` file generator for crates in ÐecisionToolkit project.

use super::*;

/// Creates a `README.md` file for a crate in ÐecisionToolkit project.
pub fn get_readme_for_decision_toolkit_crate(file_name: impl AsRef<Path>) -> Result<String> {
  let mut output = String::new();
  let body = utils::read_file(file_name)?;
